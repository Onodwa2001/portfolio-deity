export default function Projects() {
    const projects = [
        ...
        },
        {
            ...
            image: 'https://plus.unsplash.com/premium_photo-1676637000058-96549206fe71?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3Ds',
        },
        ...
        <section id="projects" className="py-20 bg-darkGray text-white overflow-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-10">
                {projects.map((project) => (
                    <div key={project.id} className="relative bg-darkGray border border-neon rounded-xl shadow-neon hover:shadow-deepBlue transition-shadow overflow-hidden group">
                        {/* Neon Border Effect */}
